...
class Query(FestivalQueries,UserQueries, TermsQueries, ReviewQueries,UserAgreeQueries,UserFestivalLikeQueries,GoodsQueries,UserChatQueries,ChatLogQueries,ScheduleQueries,graphene.ObjectType):
    pass
